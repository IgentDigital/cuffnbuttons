...
{
    public partial class Shirt_Main : System.Web.UI.Page
    {
        ...
        private void FetchProductDetail()
        {
            ...
            {
                this.ProductImage.ImageUrl = dsProduct.Tables[0].Rows[0]["ShowcaseImageUrl"].ToString();
        ...
        protected void LikeList_ItemCommand(object source, DataListCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("Shirt_Main.aspx?SKU=" + e.CommandArgument);
            }
        }
