<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPatternType.aspx.cs" Inherits="CuffsnButtons.AddPatternType" %>
								  ...
								  <tr>
                                      <td valign="top">
                                          ...
                                          <table  width="100%">
                                              ...
                                              <tr>
                                                  <td style="padding-left:15px" >Pattern Type *</td>
                                                  <td>
                                                      <asp:TextBox runat="server" ID="txtPatternType"></asp:TextBox>
                                                      <asp:RequiredFieldValidator runat="server" ID="rfvPatternType" ControlToValidate="txtPatternType" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator runat="server" ID="regPatternType" ControlToValidate="txtPatternType" ErrorMessage="Maximum Characters can be allowed is 30" ForeColor="Red" ValidationExpression="^.{1,30}$"></asp:RegularExpressionValidator>
                                                  </td>
                                              </tr>
							         ...
							         <td width="31%" >
							          <asp:TextBox runat="server" ID="txtFabricType"></asp:TextBox>
								    ...
								    <tr>
                                        <td>Weave</td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtWeave"></asp:TextBox>
                                        </td>
								    </tr>
									   <tr>
                                           <td>Weight</td>
                                           <td>
                                               <asp:DropDownList runat="server" ID="ddlWeight">
                                                   <asp:ListItem Text="Light"></asp:ListItem>
                                                   <asp:ListItem Text="Medium"></asp:ListItem>
                                                   <asp:ListItem Text="Heavy"></asp:ListItem>
                                               </asp:DropDownList>
                                           </td>
									   </tr>--%>
								   ...
								   <tr>
									 ...
									 <tr>
									  <td><asp:HiddenField runat="server" ID="hdnPatternTypeID" /> </td>
								   </tr>
									<tr>
									...
									<tr>
									  ...
									  <td valign="top" width="50%">
                                          <fieldset><legend>Pattern List</legend>
                                          <table width="100%">
                                              <tr><td align="center">
                                          ...
                                          >
                                                        <Columns>
                                                           <asp:BoundField DataField="PatternType" HeaderText="PatternType" />
                                                            <asp:TemplateField HeaderText="Active">
                                                             ...
                                                             <asp:templatefield>
                                                                <itemtemplate>
                                                                    <asp:HiddenField runat="server" ID="hdnPatternType" Value='<%# Eval("PatternTypeID") %>' />
