<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddColorList.aspx.cs" Inherits="CuffsnButtons.AddColorList" %>
                                          ...
                                          <table  width="100%">
                                              ...
                                              <tr>
                                                  ...
                                                  <td>
                                                      ...
                                                      <asp:RequiredFieldValidator runat="server" id="rfvColor" Display="Dynamic" ControlToValidate="txtColor" ForeColor="Red"></asp:RequiredFieldValidator>                                                  
                                                  <asp:RegularExpressionValidator runat="server" ID="regColor" ControlToValidate="txtColor" ErrorMessage="Maximum Characters can be allowed is 30" ForeColor="Red" ValidationExpression="^.{1,30}$"></asp:RegularExpressionValidator>
                                                </td>
                                              </tr>
								   <tr>
									 ...
									 <tr>
									  <td><asp:HiddenField runat="server" ID="hdnColorID" /> </td>
								   </tr>
									<tr>
									...
									<tr>
									  ...
									  <td valign="top" width="50%">
                                          <fieldset><legend>Color  List</legend>
                                          <table width="100%">
                                              <tr><td align="center">
                                                        ...
                                                        <Columns>
                                                           <asp:BoundField DataField="COLOR" HeaderText="COLOR" />
                                                            <asp:TemplateField HeaderText="Active">
                                                             ...
                                                             <asp:templatefield>
                                                                <itemtemplate>
                                                                    <asp:HiddenField runat="server" ID="hdnColor" Value='<%# Eval("ColorID") %>' />
