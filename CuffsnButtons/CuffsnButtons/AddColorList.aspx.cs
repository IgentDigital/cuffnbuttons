...
{
    public partial class AddColorList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                lblHeader.Text = "Add Color List";
                rfvColor.ErrorMessage = "Required Field.";
            }
        }
        ...
        {
            DataTable dtUserData = objcProductMaster.GetColorList();
        ...
        protected void gvDetails_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("xyx"))
            {
                ...
                hdnColorID.Value = ((HiddenField)(row.Cells[2].FindControl("hdnColor"))).Value;
                txtColor.Text = row.Cells[0].Text;
                chckIsActive.Checked = ((CheckBox)(row.Cells[1].FindControl("IsActive_chck"))).Checked;
                btnSave.Visible = false;
                btnUpdate.Visible = true;
                chkNewRecord.Visible = true;
                lblHeader.Text = "Update Color List";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                objcProductMaster.Color = txtColor.Text.Trim();

                int result = objcProductMaster.SaveColorList(objcProductMaster);
                if (result > 0)
                {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                objcProductMaster.ColorID = Convert.ToInt32(hdnColorID.Value);

                int result = objcProductMaster.UpdateColorList(objcProductMaster);
                if (result > 0)
                {
