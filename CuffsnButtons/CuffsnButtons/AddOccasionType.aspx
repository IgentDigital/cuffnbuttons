<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddOccasionType.aspx.cs" Inherits="CuffsnButtons.AddOccasionType" %>
							     ...
							     <table align="center" width="90%">
								   ...
								   <tr>
									  <td valign="top" width="50%">
                                          <fieldset><legend>Occasion List</legend>
                                          <table width="100%">
                                              <tr><td align="center">
                                          <asp:Label runat="server" ID="lblGridRcrd"></asp:Label>
                                          <asp:GridView Width="90%" ID="gvDetails"  runat="server" PageSize="5" AllowPaging="true"
                                                        ...
                                                        <Columns>
                                                           <asp:BoundField DataField="OccasionType" HeaderText="OccasionType" />
                                                            <asp:TemplateField HeaderText="Active">
                                                             ...
                                                             <asp:templatefield>
                                                                <itemtemplate>
                                                                    <asp:HiddenField runat="server" ID="hdnOccasionID" Value='<%# Eval("OccasionID") %>' />
								  ...
								  <tr>
                                      <td valign="top">
                                          ...
                                          <table  width="100%">
                                              ...
                                              <tr>
                                                  <td width="30%" >Occasion Name *</td>
                                                  <td>
                                                      <asp:TextBox runat="server" ID="txtOccasionName"></asp:TextBox>
                                                      <asp:RequiredFieldValidator runat="server" ID="rfvOccasionName" ControlToValidate="txtOccasionName" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                                                      <asp:RegularExpressionValidator runat="server" ID="regOccasionType" ControlToValidate="txtOccasionName" ErrorMessage="Maximum Characters can be allowed is 30" ForeColor="Red" ValidationExpression="^.{1,30}$"></asp:RegularExpressionValidator>
                                                
                                                       </td>
                                              </tr>
								   <tr>
									  <td >Is Active</td><td><asp:CheckBox runat="server" ID="chckIsActive" />
									  </td>
								   </tr>
									 <tr>
									  <td><asp:HiddenField runat="server" ID="hdnOccasionNameID" /> </td>
								   </tr>
									<tr>
									...
									<asp:Button runat="server" ID="btnUpdate" Text="Update"  OnClick="btnUpdate_Click" />&nbsp;&nbsp;
                                          <asp:Button runat="server" ID="chkNewRecord" Text="Add New Record" CausesValidation="false"  OnClick="chkNewRecord_CheckedChanged" />
