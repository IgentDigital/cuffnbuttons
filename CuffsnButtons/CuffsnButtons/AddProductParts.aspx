<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddProductParts.aspx.cs" Inherits="CuffsnButtons.AddProductParts" %>
							     ...
							     <table align="center" width="90%">
								  ...
								  <tr>
                                              ...
                                              <tr>
                                                  ...
                                                  <td>
                                                    <asp:DropDownList runat="server" ID="ddlProduct"></asp:DropDownList>
                                                      <asp:RequiredFieldValidator runat="server" ID="rfvProduct" Display="Dynamic" ControlToValidate="ddlProduct" InitialValue="0" ForeColor="Red" ErrorMessage="Required Field"></asp:RequiredFieldValidator>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td style="padding-left:15px">Part Name *</td>
                                                  <td>
                                                      <asp:TextBox runat="server" ID="txtPartName"></asp:TextBox>
                                                      <asp:RequiredFieldValidator runat="server" ID="rfvPartName" Display="Dynamic" ControlToValidate="txtPartName" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator runat="server" ID="regPartName" ControlToValidate="txtPartName" ErrorMessage="Maximum Characters can be allowed is 30" ForeColor="Red" ValidationExpression="^.{1,30}$"></asp:RegularExpressionValidator>
								   ...
								   <tr>
									 ...
									 <tr>
									  <td><asp:HiddenField runat="server" ID="hdnPartTypeID" /> </td>
								   </tr>
									<tr>
									...
									<tr>
									  ...
									  <td valign="top" width="50%">
                                          <fieldset><legend>Product Parts List</legend>
                                          <table width="100%">
                                              <tr><td align="center">
                                                            ...
                                                            <asp:TemplateField HeaderText="Active">
                                                             ...
                                                             <asp:templatefield>
                                                                <itemtemplate>
                                                                    ...
                                                                    <asp:HiddenField runat="server" ID="hdnPartType" Value='<%# Eval("PartTypeID") %>' />
