...
{
    public partial class AddOccasionType : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                lblHeader.Text = "Add Occasion Type";
                rfvOccasionName.ErrorMessage = "Required Field.";
            }
        }
        ...
        {
            DataTable dtUserData = objcProductMaster.GetOccasionType();
        ...
        protected void gvDetails_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("xyx"))
            {
                ...
                hdnOccasionNameID.Value = ((HiddenField)(row.Cells[2].FindControl("hdnOccasionID"))).Value;
                txtOccasionName.Text = row.Cells[0].Text;
                chckIsActive.Checked = ((CheckBox)(row.Cells[1].FindControl("IsActive_chck"))).Checked;
                btnSave.Visible = false;
                btnUpdate.Visible = true;
                chkNewRecord.Visible = true;
                lblHeader.Text = "Update Occasion Type";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                objcProductMaster.OccasionType = txtOccasionName.Text.Trim();

                int result = objcProductMaster.SaveOccasionType(objcProductMaster);
                if (result > 0)
                {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                objcProductMaster.OccasionID = Convert.ToInt32(hdnOccasionNameID.Value);

                int result = objcProductMaster.UpdateOccasionType(objcProductMaster);
                if (result > 0)
                {
