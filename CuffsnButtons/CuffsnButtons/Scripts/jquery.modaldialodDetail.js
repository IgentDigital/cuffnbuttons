...
(function ($) {
	...
	function showDialog(msg, options) {
			...
			$(dialog).html(
				...
				"<div id='dialog-content'>" +
					...
					"<div id='dialog-button-container'>" +
						"<input type='button' id='dialog_button_cntnShppng' value='Close'>"  +
					"</div>" +
				"</div>"
				);
		...
		//	$("#dialog_button_proceed").click(function () {
				document.location = "http://demowebsample/Checkout.aspx";
		//		//document.location = "http://localhost:51213/Checkout.aspx";
		//		//window.location.href('http://localhost:51213/Checkout.aspx');
		//	});
