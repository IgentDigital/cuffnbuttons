...
(function($) {
	...
	function showDialog (msg, options) {
		...
		if (!document.getElementById('dialog')) {
			...
			$(dialog).html(
				...
				"<div id='dialog-content'>" +
					...
					"<div id='dialog-button-container'>" +
						"<input type='button' id='dialog_button_cntnShppng' value='Continue Shopping'> &nbsp;<input type='button' id='dialog_button_proceed'  value='Proceed to Checkout'>" +
					"</div>" +
				"</div>"
				);
			...
			$("#dialog_button_cntnShppng").click(modaldialog.hide);
			//$("#dialog_button_proceed").click(al());
			$("#dialog-button").click(modaldialog.hide);
		}

		$(document).ready(function () {
		    $("#dialog_button_proceed").click(function () {
		        document.location = "http://localhost:52182/Checkout.aspx";
		        //window.location.href('http://localhost:52182/Checkout.aspx');
		    });
