<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductMaster.aspx.cs" Inherits="CuffsnButtons.ProductMaster" %>
    ...
    <table width="100%" align="center">
       ...
       <%-- <tr>
            <td width="100%" align="center" height="3px">
                <asp:Label ForeColor="Red" runat="server" ID="lblSignMessage">&nbsp;</asp:Label>
            </td>
        </tr>--%>
<tr>                                           
                    <td valign="top" witdh="100%">
                        <table class="calendar_table" width="100%" style="min-height:400px;"  id="Table1">
                            <tr>
							 ...
							 <tr>
							   <td width="60%" valign="top" style="vertical-align:top;" align="center">
                                    <asp:Label ForeColor="Red" runat="server" ID="lblSignMessage">&nbsp;</asp:Label>
							     <table align="center" width="90%">
								  ...
								  <tr>
                                      <td valign="top">
                                          ...
                                          <table  width="100%">
                                              <tr><th colspan="2" width="100%" align="center" style="background-color:#A4A4A4;color:white;"><asp:label runat="server" ID="lblHeader">Add Product Type</asp:label></th></tr>
                                              
                                          <tr><td width="15%" style="padding-left:15px">
							           Product Name *
							         </td >
							         <td width="31%" >
							          <asp:TextBox runat="server" ID="txtProduct" MaxLength="30"></asp:TextBox>
                                         <asp:RequiredFieldValidator runat="server" ID="rfvProduct" ForeColor="Red" ControlToValidate="txtProduct" Display="Dynamic"></asp:RequiredFieldValidator>
						                <asp:RegularExpressionValidator runat="server" ID="regProductName" ControlToValidate="txtProduct" ErrorMessage="Maximum Characters can be allowed is " ForeColor="Red" ValidationExpression="^.{1,30}$"></asp:RegularExpressionValidator>
                                     </td>
								   </tr>
								   ...
								   <tr>
									 ...
									 <tr>
									  <td><asp:HiddenField runat="server" ID="hdnUserId" /> </td>
								   </tr>
									<tr>
									  
									  <th width="100%" colspan="2" align="Center" style="background-color:#A4A4A4;color:white;">
                                          <asp:Button runat="server" ID="btnSave" Text="Save" OnClick="btnSave_Click" /> &nbsp;
									<asp:Button runat="server" ID="btnUpdate" Text="Update" OnClick="btnUpdate_Click" />&nbsp;&nbsp;
                                          <asp:Button runat="server" ID="chkNewRecord" CausesValidation="false" Text="Add New Record" OnClick="chkNewRecord_CheckedChanged" />
									...
									<tr>
									  ...
									  <td valign="top" width="50%">
                                          <fieldset><legend>Product Type List</legend>
                                          <table width="100%">
                                              <tr><td align="center">
                                          <asp:Label runat="server" ID="lblGridRcrd"></asp:Label>
                                          <asp:GridView Width="90%" ID="gvDetails"  runat="server" AllowPaging="true" PageSize="6"
                                          ...
                                          >
                                                        <Columns>
                                                           <asp:BoundField DataField="SKUType" HeaderText="Product" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Active">
                                                             ...
                                                             <asp:templatefield>
                                                                <itemtemplate>
                                                                        <asp:HiddenField runat="server" ID="hdnSkuTypeID" Value='<%# Eval("SkutypeId") %>' />
