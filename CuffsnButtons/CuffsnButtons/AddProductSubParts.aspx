<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddProductSubParts.aspx.cs" Inherits="CuffsnButtons.AddProductSubParts" %>
                                          ...
                                          <table  width="100%">
                                              ...
                                              <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" ID="rfvProductName" InitialValue="0" Display="Dynamic" ControlToValidate="ddlProductName" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </td>
                                              </tr>
                                              <tr>
                                                  <td style="padding-left:15px">Part Name *</td>
                                                  <td>
                                                      <asp:DropDownList runat="server" ID="ddlPartName"></asp:DropDownList>
                                                      <asp:RequiredFieldValidator runat="server" ID="rfvPartName" InitialValue="0" Display="Dynamic" ControlToValidate="ddlPartName" ForeColor="Red"></asp:RequiredFieldValidator>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td style="padding-left:15px">Sub Part Name *</td>
                                                  <td>
                                                      <asp:TextBox runat="server" ID="txtSubPartName"></asp:TextBox>
                                                      <asp:RequiredFieldValidator runat="server" id="rfvSubpart" Display="Dynamic" ControlToValidate="txtSubPartName" ForeColor="Red"></asp:RequiredFieldValidator>
                                                     <asp:RegularExpressionValidator runat="server" ID="regSubPartName" ControlToValidate="txtSubPartName" ErrorMessage="Maximum Characters can be allowed is 30" ForeColor="Red" ValidationExpression="^.{1,30}$"></asp:RegularExpressionValidator>

                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td style="padding-left:15px">Icon URL</td>
                                                  <td>
                                                      <asp:FileUpload ID="UploadImgURL" runat="server" />
                                                      <%--<asp:RequiredFieldValidator ID="rqfvInputFile" runat="server" Display="Dynamic" ControlToValidate="UploadImgURL"></asp:RequiredFieldValidator>--%>
                                                      <asp:Label runat="server" ID="txtImageURL"></asp:Label>
                                                  </td>
                                              </tr>
								   <tr>
									 ...
									 <tr>
									  <td><asp:HiddenField runat="server" ID="hdnSubPartTypeID" /> </td>
								   </tr>
									<tr>
									...
									<asp:Button runat="server" ID="btnUpdate" Text="Update" OnClick="btnUpdate_Click" />&nbsp;&nbsp;
                                          <asp:Button runat="server"  CausesValidation="false" ID="chkNewRecord" Text="Add New Record" OnClick="chkNewRecord_CheckedChanged" />
									...
									<tr>
									  ...
									  <td valign="top" width="50%">
                                          <fieldset><legend>Product Sub Parts List</legend>
                                          <table width="100%">
                                              <tr><td align="center">
                                          <asp:Label runat="server" ID="lblGridRcrd"></asp:Label>
                                          <asp:GridView Width="90%" ID="gvDetails"  runat="server" AllowPaging="true"
                                              PageSize="5" 
                                                        ...
                                                        <Columns>
                                                           <asp:BoundField DataField="SKUType" HeaderText="Product Name" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Active">
                                                             ...
                                                             <asp:templatefield>
                                                                <itemtemplate>
                                                                    <asp:HiddenField runat="server" ID="hdnPartTyprID" Value='<%# Eval("PartTypeID") %>' />
                                                                    <asp:HiddenField runat="server" ID="hdnSubPartType" Value='<%# Eval("SubPartTypeID") %>' />
                                                                    <asp:HiddenField runat="server" ID="hdnProductID" Value='<%# Eval("SKUTypeID") %>' />
